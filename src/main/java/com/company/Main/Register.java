...
public class Register{
    public static void RestaurantAndOwner(RestaurantOwner owner, String restaurant_name, String phone, int location_id,
                                          int category_id) throws NoSuchAlgorithmException {
        owner.insertIntoDB();
